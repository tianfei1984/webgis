	...
	var filter = this.filterParams.filter;
     $.ajax({
            ...
            success: function(data){
				...
				if(isUpdate == false)
				{
					treeManager.tree({checkbox:true,lines:true,data:treeData,loadFilter:myLoadFilter,loadMsg:'数据加载中...', 
...
{
	var url = globalConfig.webPath+"/vehicle/registerVehicles.action"
