...
HistoryRoutePanel.playSpeed = 300;//播放速度,
...
HistoryRoutePanel.exportExcel = function()
{
	var routeForm = $('#routeForm');
	 var queryUrl =  globalConfig.webPath+'/vehicle/gpsInfoList.action';
	 ...
	 routeForm.form({
		...
		onSubmit: function(){
			...
			if(isValid)
			{
				...
				var url = globalConfig.webPath + "/data/excelExport.action?"+strParam;
