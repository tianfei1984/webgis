...
$().ready(function() {
 ...
 <BODY>
	<form id="entityForm" name="entityForm" 
			action='<%=ApplicationPath%>/command/tempTrack.action' method="POST">
  ...
  <table width="100%"  class="TableBlock">
					...
					<tr>
						<td align="right">位置上报时间间隔(秒)
							:</td>
						<td>
						<input id="interval" name="interval" class="required digits"  value="10" maxlength="16" size="20" >
						</td>
					</tr>
					<tr>
						<td align="right">跟踪有效期(秒):</td>
						<td ><input id="timeSpan" name="timeSpan" class="required digits"  value="120" maxlength="16" size="20" >
						</td>
					</tr>
