...
<BODY>
	<form id="entityForm" name="entityForm" action='<%=ApplicationPath%>/command/listenTerminal.action' method="POST">
			...
			<tbody>
				<tr>
					<td colspan="2" style="font-weight: bold; background: #EFEFEF;"
						height="25">监听信息 <span style="color:red;background:blue;">${message}</span>
					</td>
				</tr>
				<tr>
					<td align="right">监听类型 :</td>
					<td><select id="listenType" style="width: 150px;"
						name="listenType" class="required digits">
					</select>
					</td>
				</tr>
				<tr>
					...
					<td><input id="phoneNo" name="phoneNo"
						class="required digits" value="" maxlength="16"
						size="20"></td>
				</tr>

				<td colspan=2 align="center"><input type="submit"
					class="sendjson" value="发送"> <span class="commandMsg"></span>
				</td>
				</tr>
			</tbody>
		</table>
