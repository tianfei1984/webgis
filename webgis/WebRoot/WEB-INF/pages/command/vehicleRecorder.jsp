...
<!--定时器-->
<script type="text/javascript" src="<%=jsPath%>/terminalCommand.js"></script>
<!--终端命令结果查询-->
<script>
//查询行车记录参数
		...
		<tbody>
			<tr>
				<td colspan="2" style="font-weight: bold; background: #EFEFEF;"
					height="25">行车记录仪设置 <span style="color:red;background:blue;">${message}</span>
				</td>
			</tr>
			...
			<tr>
				<td class="cmdType" id="driverInfo"><a href="#">驾驶员信息>></a></td>
				<td rowspan=11 valign="top" height=400>

					<form id="entityForm_driverInfo" name="entityForm"
						class="entityForm"
						...
						<table width="100%" class="childtable driverInfo">
							...
							<tr class="driverInfo">
								<td width="35%">驾驶员代码:</td>
								<td align=left><input type="text" name="driverNo" value=""
									class="required" /></td>
							</tr>
							<tr>
								<td>机动车驾驶证号码:</td>
								<td><input type="text" name="driverLicense" value=""
									class="required" /></td>
							</tr>
						</table>
					</form>

					<form id="entityForm_vehicleInfo" name="entityForm"
						class="entityForm"
						action='<%=ApplicationPath%>/command/vehicleRecorder.action'
						method="POST">
						<table width="100%" class="childtable vehicleInfo">
							...
							<tr class="vehicleInfo">
								<td width="20%">车辆分类:</td>
								<td><input type="text" name="vehicleType" value=""
									class="required" /></td>
							</tr>
						</table>
					</form>
					...
					<form id="entityForm_clock" name="entityForm" class="entityForm"
						...
						<table width="100%" class="childtable clock">
							<tr class="clock">
								<td width="20%">实时时钟:</td>
								<td><input type="text" name="clock" value=""
									class="datetimepicker" class="required" /></td>
							</tr>
						</table>
					</form>
					<!-- 车辆特征系数 -->
			...
			<tr>
				<td class="cmdType" id="vehicleInfo"><a href="#">车辆信息>> </a>
				</td>
			</tr>
			<tr>
				<td style="background-color:#99CCFF;">2、行驶数据信息</td>
			</tr>
			<tr>
				<td class="cmdType" id="clock"><a href="#">实时时钟>></a></td>
			</tr>
			<tr>
				<td class="cmdType" id="feature"><a href="#">车辆特征系数>> 
				</td>
			</tr>
			<tr>
				<td class="cmdType" id="mileageIn2d"><a href="#">2天内累计行驶里程(米)>>
				
				</td>
			</tr>
			<tr>
				<td class="cmdType" id="mileageIn360h"><a href="#">360h内累计行驶里程(米)>>
			...
			<tr>
				<td class="cmdType" id="speedIn360h"><a href="#">最近360h内行驶速度数据>>
				
				</td>
			</tr>
			<tr>
				<td class="cmdType" id="speedIn2d"><a href="#">2天内行驶速度数据>>
				
				</td>
			</tr>
			<tr>
				<td class="cmdType" id="accident"><a href="#">采集记录仪事故疑点数据
						>>
				</td>
			</tr>
