...
<%@ include file="/common/paginateUtil.jsp"%>
    ...
    <script type="text/javascript" src="<%=jsPath%>/ztreeutil.js"></script><!--关于ztree操作的公用函数-->
		...
		<script type="text/javascript" charset="utf-8">		
			...
			{
				var url = "<%=ApplicationPath%>/data/enclosureBinding!bindEnclosure.action";
 ...
 <td> 区域: </td>
        <td colspan="5" align="left">
	      <select id="enclosures" name="enclosures"  class="required"> </select>&nbsp;&nbsp;&nbsp;&nbsp;
           <input type="button" value="绑定车辆" class="button gray medium" onclick="bindVehicle();"/>
	       <input type="button" value="查询未绑定车辆"  class="button gray medium" id="btnQuery"/>&nbsp;&nbsp;
           <input type="reset" value="重置" class="button gray medium"/>&nbsp;&nbsp;
        </td>
    </tr>
		</table>
