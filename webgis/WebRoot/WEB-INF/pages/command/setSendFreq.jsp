...
//删除表格的某一行，删除后，会自动刷新表格			
			...
			function setSendFreq()
			{
                ...
                var strVehicleIds = vehicleIds.join(",");
				var params = {strVehicleIds:strVehicleIds};
				var url = "<%=ApplicationPath%>/command/setSendFreq.action";
...
<body>
 ...
 <tr>
        ...
        <td colspan="4" align="left">
		 ...
		 <a id="btnSetFreq" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" >设置正常发送频率</a>&nbsp;
		   <a id="btnReset" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-clear'" >重置</a>&nbsp;
			...
			<table id="queryGrid" class="easyui-datagrid" title="" style="width:100%;"
						data-options="pagination:true,pageSize:15,singleSelect:false,rownumbers:true,striped:true,fitColumns: true,onDblClickRow:onGridDblClickRow,
						pageList: [15, 20, 50, 100, 150, 200],fit:true,toolbar:'#toolbar',
						url:'<%=ApplicationPath%>/report/onlineVehicleList.action',method:'post'">
					<thead>
						<tr>
							<th data-options="field:'vehicleId',checkbox:true"   width="100"><input type='checkbox' id='selectAll'></input></th>
							...
							<th data-options="field:'onlineDate'"  width="18%">上线时间</th>
