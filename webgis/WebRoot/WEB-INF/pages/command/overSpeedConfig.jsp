...
$().ready(function() {
 ...
 <BODY>
	<form id="entityForm" name="entityForm" 
			action='<%=ApplicationPath%>/command/overSpeedConfig.action' method="POST">
				<!--超速设置-->
  ...
  <table width="100%"  class="TableBlock">
					...
					<tr>
						<td align="right">最高速度
							:</td>
						<td>
						<input type="hidden" name="paramId" value="0x0055" />
						<input type="text" id="param_1"   name="paramValue" maxlength="16" size="20"  value="80"
						   class="required digits">(公里/小时)
						  </td>
					</tr>
					<tr>
						<td align="right">超速持续时间:</td>
						<td >
						<input type="hidden" name="paramId" value="0x0056" />
						<input type="text" id="param_2"   name="paramValue" maxlength="16" size="20"  value="10"
