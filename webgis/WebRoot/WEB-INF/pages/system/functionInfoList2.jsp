...
<body>
		<div id="container" >		
			...
			<form id="queryForm" action="<%=ApplicationPath%>/system/functionInfoList.action">
			  ...
			  <table width="100%"  class="TableBlock">
			   ...
			   <td> 权限名称: </td>
				...
				<td align="left">
				   <select name="funcType" id="funcType" style="width:150px" >  
				   </select>
				</td>
				<td align="right">上级菜单:</td>
						<td align="left"><select id="parentId"  style="width: 150px;" name="parentId" >
						   </select>
						</td>
